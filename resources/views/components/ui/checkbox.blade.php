...
<label {{ $attributes->only('class')->merge(['class' => 'inline-flex items-center gap-3 cursor-pointer select-none group py-3']) }}>
    <span class="relative flex h-[18px] w-[18px] shrink-0 items-center justify-center">
        ...
        <span
            aria-hidden="true"
            class="pointer-events-none absolute inset-0 rounded-[5px] border border-border bg-bg transition-all duration-200
        ...
        <svg
            ...
            viewBox="0 0 12 12"
            fill="none"
            class="pointer-events-none relative z-[1] h-2.5 w-2.5 text-bg opacity-0 transition-opacity duration-150 peer-checked:opacity-100 checkbox-check"
        >
